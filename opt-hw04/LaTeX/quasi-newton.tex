...
\begin{Verbatim}[commandchars=\\\{\}]
<mpl\_toolkits.mplot3d.art3d.Poly3DCollection at 0x7efbea10c0a0>
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{sol} \PY{o}{=} \PY{n}{broyden}\PY{p}{(}\PY{n}{quadratic}\PY{p}{,} \PY{n}{quadratic\PYZus{}derivatives}\PY{p}{,} \PY{n}{x0}\PY{p}{,} \PY{n}{grad\PYZus{}min}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{,}
              \PY{n}{h\PYZus{}method}\PY{o}{=}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mf}{0.9}\PY{p}{)}\PY{p}{,} \PY{n}{full\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\PY{n}{ax1}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Квадратичная функция,}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+si}{\PYZob{}}\PY{n+nb}{len}\PY{p}{(}\PY{n}{sol}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{ итераций}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{n}{sol} \PY{o}{=} \PY{n}{broyden}\PY{p}{(}\PY{n}{rosenbrock}\PY{p}{,} \PY{n}{rosenbrock\PYZus{}derivatives}\PY{p}{,} \PY{n}{x0}\PY{p}{,} \PY{n}{grad\PYZus{}min}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{,}
              \PY{n}{h\PYZus{}method}\PY{o}{=}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mf}{0.9}\PY{p}{)}\PY{p}{,} \PY{n}{full\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\PY{n}{ax2}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Функция Розенброка,}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+si}{\PYZob{}}\PY{n+nb}{len}\PY{p}{(}\PY{n}{sol}\PY{p}{)}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s1}{ итераций}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
Text(0.5, 1.0, 'Функция Розенброка,\textbackslash{}n556 итераций')
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{sol} \PY{o}{=} \PY{n}{dfp}\PY{p}{(}\PY{n}{quadratic}\PY{p}{,} \PY{n}{quadratic\PYZus{}derivatives}\PY{p}{,} \PY{n}{x0}\PY{p}{,} \PY{n}{grad\PYZus{}min}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{,}
          \PY{n}{h\PYZus{}method}\PY{o}{=}\PY{l+m+mf}{0.05}\PY{p}{,} \PY{n}{full\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\PY{n}{cn} \PY{o}{=} \PY{n}{ax1}\PY{o}{.}\PY{n}{contourf}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{,} \PY{n}{quadratic}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{)}\PY{p}{,} \PY{n}{levels}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{cm}\PY{o}{.}\PY{n}{coolwarm}\PY{p}{)}
\PY{n}{sol} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{sol}\PY{p}{)}
\PY{n}{ax1}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{lw}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{)}
\PY{n}{fig}\PY{o}{.}\PY{n}{colorbar}\PY{p}{(}\PY{n}{cn}\PY{p}{,} \PY{n}{ax}\PY{o}{=}\PY{n}{ax1}\PY{p}{)}
...
\PY{n}{sol} \PY{o}{=} \PY{n}{dfp}\PY{p}{(}\PY{n}{rosenbrock}\PY{p}{,} \PY{n}{rosenbrock\PYZus{}derivatives}\PY{p}{,} \PY{n}{x0}\PY{p}{,} \PY{n}{grad\PYZus{}min}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{,}
          \PY{n}{h\PYZus{}method}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{n}{full\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\PY{n}{cn} \PY{o}{=} \PY{n}{ax2}\PY{o}{.}\PY{n}{contourf}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{,} \PY{n}{rosenbrock}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{)}\PY{p}{,} \PY{n}{levels}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{cm}\PY{o}{.}\PY{n}{coolwarm}\PY{p}{)}
\PY{n}{sol} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{sol}\PY{p}{)}
\PY{n}{ax2}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{lw}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{)}
\PY{n}{fig}\PY{o}{.}\PY{n}{colorbar}\PY{p}{(}\PY{n}{cn}\PY{p}{,} \PY{n}{ax}\PY{o}{=}\PY{n}{ax2}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
Text(0.5, 1.0, 'Функция Розенброка,\textbackslash{}n145 итераций')
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{sol} \PY{o}{=} \PY{n}{bfgs}\PY{p}{(}\PY{n}{quadratic}\PY{p}{,} \PY{n}{quadratic\PYZus{}derivatives}\PY{p}{,} \PY{n}{x0}\PY{p}{,} \PY{n}{grad\PYZus{}min}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{,}
           \PY{n}{h\PYZus{}method}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{n}{full\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\PY{n}{cn} \PY{o}{=} \PY{n}{ax1}\PY{o}{.}\PY{n}{contourf}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{,} \PY{n}{quadratic}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{)}\PY{p}{,} \PY{n}{levels}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{cm}\PY{o}{.}\PY{n}{coolwarm}\PY{p}{)}
\PY{n}{sol} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{sol}\PY{p}{)}
\PY{n}{ax1}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{lw}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{)}
...
\PY{n}{sol} \PY{o}{=} \PY{n}{bfgs}\PY{p}{(}\PY{n}{rosenbrock}\PY{p}{,} \PY{n}{rosenbrock\PYZus{}derivatives}\PY{p}{,} \PY{n}{x0}\PY{p}{,} \PY{n}{grad\PYZus{}min}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}4}\PY{p}{,}
           \PY{n}{h\PYZus{}method}\PY{o}{=}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{n}{full\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
\PY{n}{cn} \PY{o}{=} \PY{n}{ax2}\PY{o}{.}\PY{n}{contourf}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{,} \PY{n}{rosenbrock}\PY{p}{(}\PY{o}{*}\PY{n}{mesh}\PY{p}{)}\PY{p}{,} \PY{n}{levels}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{n}{plt}\PY{o}{.}\PY{n}{cm}\PY{o}{.}\PY{n}{coolwarm}\PY{p}{)}
\PY{n}{sol} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{sol}\PY{p}{)}
\PY{n}{ax2}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{sol}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{k\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{lw}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
Text(0.5, 1.0, 'Функция Розенброка,\textbackslash{}n559 итераций')
\end{Verbatim}
\end{tcolorbox}
